<?php if(!defined('BASEPATH')) exit('No direct script access allowed');
  ...
  */
  class Datatables
  {
    ...
    * @return mixed
    */
    public function edit_view_big_modal($column, $content, $match_replacement)
    {
      $this->edit_columns[$column][] = array('content' =>"<center><a href='".base_url($content)."' data-toggle='modal' data-target='#bigbasic'><i class='icon-eye'></i> </a></center>", 'replacement' => $this->explode(',', $match_replacement));
      return $this;
    }
