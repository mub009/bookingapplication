...
class Legancy
{
    ...
    public function design($assign_value=null,$item_name)
    {
        ...
        $this->data['legancy']['Inactive']=$this->Inactive();
   ...
   return "<li> <span class='label label-sm label-danger'> Actions </span>&nbsp&nbsp Indicate Edit and Delete $this->item_name </li><br>";
    ...
    {
   return "<li><span class='label label-sm btn purple-soft'>Inactive </span>&nbsp&nbsp Indicate $this->item_name Item is Inactive </li><br>";
    }
