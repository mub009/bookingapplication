  ...
  class Userfilter
  {
    ...
    */
    ...
    public function rapping()
    {
      ...
      return $this->ci->load->view('template/TemplateTools/datatable/design3/datatable',$this->data,true);
    ...
    public function datatable()
    {
      ...
      return $this->ci->load->view('template/TemplateTools/datatable/design3/table',$this->datatable,true);
    ...
    {
       return $this->ci->load->view('template/TemplateTools/datatable/design3/toolbar',$this->toolbar,true);
    }
