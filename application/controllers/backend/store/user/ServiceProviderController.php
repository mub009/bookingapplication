...
class ServiceProviderController extends Store_Controller
{
 ...
 {
  parent::__construct();
  $this->title_name = 'Service Provider';
 ...
 public function index()
 {
      ...
      $this->data['legancy']=$this->Legancy->design(array('add','active','actions','block','view'),'Service Provider');
...
public function _Datatable_config()
    ...
    public function ajaxAction_datatable()
    {
        ...
        ->where(array('storemployee.is_deleted'=>0,'storemployee.storeId'=>$this->data['userInfo']['storeId'],'storemployee.role'=>'serviceProvider'))
        ->from('storemployee');
...
public function addUI()
   {  
     $this->load->view('backend/store/user/serviceProvider/Modal_InserUI');
   }
public function editUI($storeEmployeeId)
   {  
     ...
     $this->load->view('backend/store/user/serviceProvider/modal_updateUI', $this->data);
   }
