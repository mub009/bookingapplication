...
class LocationSettingController extends Store_Controller
{   
    ...
    public function index()
    {
        ...
        $this->template('booking/storesettings/location/location', $this->data);
    }
    ...
    {
        $this->load->view('backend/store/booking/storesettings/location/locationAddUI',$this->data);
    }
    public function editLocationUI($storeLocationId)
    {
        ...
        $this->load->view('backend/store/booking/storesettings/location/locationEditUI',$this->data);
    }
    public function locationTimeUI($storeLocationId)
    {
        $this->data['view']=$this->StoreModel->decryptGetStoreLocationDetails($this->data['userInfo']['storeId'],$storeLocationId);
        $this->template('booking/storesettings/location/storeTime', $this->data);
    }
    ...
    {
        $this->data['view']=$this->StoreModel->decryptGetStoreLocationDetails($this->data['userInfo']['storeId'],$storeLocationId);
        $this->load->view('backend/store/booking/storesettings/location/locationDelete',$this->data);
    }
