...
class CategoriesController extends Store_Controller
{
 ...
 protected $title_nav_bar;
  ...
  {
    $this->data['categories']=$this->StoreModel->getCategoriesByShopId($this->data['userInfo']['storeId']);
    $this->template('booking/categories/categories',$this->data);
  }
  public function menuName_validation()
  {

  }
  public function withOutCSRF_addUI()
  {
    $this->template('booking/categories/categoriesAdd');
  }
  public function withOutCSRF_editUI($storeServiceCategoriesId)
  {
    $this->data['view']=$this->StoreModel->getCategoriesDetailsByStoreServiceCategoriesId($storeServiceCategoriesId);
    $this->template('booking/categories/categoriesEdit',$this->data);
  }
  ...
  {
    $this->data['view']=$this->StoreModel->getCategoriesDetailsByStoreServiceCategoriesId($storeServiceCategoriesId);
    $this->load->view('backend/store/booking/categories/categoryDelete',$this->data);
  }
  ...
  {
    $this->data['view']=$this->StoreModel->getCategoriesDetailsByStoreServiceCategoriesId($storeServiceCategoriesId);
    $this->load->view('backend/store/booking/categories/categoryVisibility',$this->data);
  }
