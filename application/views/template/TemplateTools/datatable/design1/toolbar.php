<div class="table-toolbar">
    <div class="row">
        <div class="col-md-6">
            <?php
if (in_array($privilege_value, $privilege_array) or $privilege_value=='*') {
    ?>
            <div class="btn-group">
                <?php
if(!empty($link_value))
...
{
    ?>
                <a id="sample_editable_1_new" class="btn blue-hoki" data-target="#add" data-toggle="modal"> Add &nbsp<i
                        class="fa fa-plus"></i></a>
                <?php
}
else {
        ?>
                <a href="<?=base_url() . $link_value?> " id="sample_edittable_1_new" class="btn blue-hoki"
