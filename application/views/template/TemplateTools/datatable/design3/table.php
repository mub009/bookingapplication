...
<table class="table table-striped table-bordered table-hover table-checkable order-column" id="<?=(!empty($table_name))?$table_name:'design3'?>">
    <thead>
        <tr>
            <?php
...
function Datatable(filterData=null)
{
  ...
  this.<?=(!empty($table_name))?$table_name:'datatableobj'?>=$('#<?=(!empty($table_name))?$table_name:'design3'?>').DataTable({
...
$('#filter').click(function (e) { 
    ...
    $('#<?=(!empty($table_name))?$table_name:'design3'?>').DataTable().destroy();
