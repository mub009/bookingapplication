            ...
            <div id="wrapper">
                ...
                <div class="content">
                            ...
                            <div class="slider-container">
                                ...
                                <div class="slider-item fl-wrap">
                                    <div class="hero-parallax">
                                        <div class="bg"  data-bg="<?=base_url('assets/website/booking/1/')?>images/bg/23.jpg" data-scrollax="properties: { translateY: '200px' }"></div>
                                        <div class="overlay op7"></div>
                                    </div>
                                    <div class="hero-section-wrap fl-wrap">
                                        <div class="container">
                                            <div class="home-intro-card">
                                                <div class="home-intro-card-counter">NATMCO APP</div>
                            ...
                            <div class="listing-carousel  fl-wrap ">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="listing-single.html"><img src="<?=base_url('assets/website/booking/1/')?>images/gal/1.jpg" alt=""></a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="images/avatar/1.jpg" alt=""></a>
                                                    <span class="avatar-tooltip">Added By  <strong>Alisa Noory</strong></span>
                                                </div>
                                                <div class="sale-window">NATMCO APP</div>
                                                <div class="geodir-category-opt">
                                                    <div class="listing-rating card-popup-rainingvis"><strong style="color: #fff;">Narcissus Clinic</strong></div>
                                ...
                                <div class="slick-slide-item">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="listing-single.html"><img src="<?=base_url('assets/website/booking/1/')?>images/gal/2.jpg" alt=""></a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="<?=base_url('assets/website/booking/1/')?>images/avatar/1.jpg" alt=""></a>
                                                    <span class="avatar-tooltip">Added By  <strong>Alisa Noory</strong></span>
                                                </div>
                                                <div class="sale-window">NATMCO APP</div>
                                                <div class="geodir-category-opt">
                    ...
                    <section class="parallax-section" data-scrollax-parent="true">
                        <div class="bg"  data-bg="<?=base_url('assets/website/booking/1/')?>images/bg/2.jpg" data-scrollax="properties: { translateY: '100px' }"></div>
                        <div class="overlay op7"></div>
                        <!--container-->
                        <div class="container">
                            <div class="row">
                                            ...
                                            <div class="slick-slide-item">
                                                <div class="hotel-card fl-wrap title-sin_item">
                                                    <div class="geodir-category-img card-post">
                                                        <a href="listing-single.html"><img src="<?=base_url('assets/website/booking/1/')?>images/gal/8.jpg" alt=""></a>
                                                        <div class="listing-counter">Narcissus Doctor </div>
                                                        
                                                        <div class="geodir-category-opt">
                                                           
                                                            <h4 class="title-sin_map"><a href="listing-single.html">Dr Lorem Ipsum</a></h4>
                                                            <div class="geodir-category-location"><a href="#" class="single-map-item" > Plastic Surgeon</a></div>
                                                            <div class="rate-class-name">
                                ...
                                <div class="col-md-4">
                                    <article class="card-post">
                                        <div class="card-post-img fl-wrap">
                                            <a href="blog-single.html"><img  src="<?=base_url('assets/website/booking/1/')?>images/all/1.jpg"   alt=""></a>
                                        </div>
                                        <div class="card-post-content fl-wrap">
                                            <h3><a href="blog-single.html">Botox</a></h3>
                                        </div>
                                    </article>
                                </div>
                                <div class="col-md-4">
                                    <article class="card-post">
                                        <div class="card-post-img fl-wrap">
                                            <a href="blog-single.html"><img  src="<?=base_url('assets/website/booking/1/')?>images/all/2.jpg"   alt=""></a>
                                        </div>
                                        <div class="card-post-content fl-wrap">
                                            <h3><a href="blog-single.html">Laser Treatment</a></h3>
                                        </div>
                                    </article>
                                </div>
                                <div class="col-md-4">
                                    <article class="card-post">
                                        <div class="card-post-img fl-wrap">
                                            <a href="blog-single.html"><img  src="<?=base_url('assets/website/booking/1/')?>images/all/3.jpg"   alt=""></a>
                                        </div>
                                        <div class="card-post-content fl-wrap">
                                            <h3><a href="blog-single.html">Filler</a></h3>
                                        </div>
                                    </article>
                                </div>
