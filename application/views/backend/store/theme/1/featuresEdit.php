<?php
$json=json_decode($features['json']);
    ...
    <div class="portlet light form-fit bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-green bold uppercase">Edit Features</span>
            </div>
                    ...
                    <center>
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-preview thumbnail" data-trigger="fileinput"
                                ...
                                <img src="<?=$features['sliderImage100x100']?>">
                                </div>
                            <div> 
                            </div>
                        </div>
        ...
        <center>
		<a href="<?=base_url('store/theme/one/features')?>" class="btn dark btn-outline linkVa">Back</a>
		<input type="submit" class="btn green" name='submit' value="Save">
	</center>
    </div>
</div>
<input type="hidden" value="<?=$features['storeThemeDetailsId']?>" name="storeThemeDetailsId">
</form>
<script>
$(document).ready(function () {
    $('#UpdateForm').validate({
		submitHandler: function () {
            AjaxPostDataWithImage("<?=base_url('store/theme/one/featureseditraction')?>","UpdateForm",false,'<?=base_url('store/theme/one/features')?>');        
		}
	});     
});
