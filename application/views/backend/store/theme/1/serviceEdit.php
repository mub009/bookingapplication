...
<div class="modal-body">
    <div class="portlet light form-fit bordered">
                    ...
                    <center>
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-preview thumbnail" data-trigger="fileinput"
                                ...
                                <img src="<?=$service['sliderImage100x100']?>">
                                </div>
                            <div> 
                            </div>
                        </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label class="control-label col-md-5" style=" text-align:left;" for="Details">Details
                        <span class="required" aria-required="true"> * </span></label>
                    <div class="col-md-7 ">
                        <input type="text" require="" class="form-control error" name="json[details]"
                            placeholder="Enter Details" value="<?=$json->details?>" autocomplete="off" required="" aria-invalid="false">
                    </div>
                </div>
                    <center>
                        <div class="fileinput fileinput-new" data-provides="fileinput">
        ...
        <center>
		<a href="<?=base_url('store/theme/one/service')?>" class="btn dark btn-outline linkVa">Back</a>
		<input type="submit" class="btn green" name='submit' value="Save">
	</center>
    </div>
</div>
<input type="hidden" value="<?=$service['storeThemeDetailsId']?>" name="storeThemeDetailsId">
</form>
<script>
$(document).ready(function () {
    $('#UpdateForm').validate({
		submitHandler: function () {
            AjaxPostDataWithImage("<?=base_url('store/theme/one/serviceeditraction')?>","UpdateForm",false,'<?=base_url('store/theme/one/service')?>');        
		}
	});     
});
