        ...
        <div class="portlet light form-fit bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">Add Features</span>
                </div>
            </div>
    ...
    $(document).ready(function () {
        $('#InsertForm').validate({
            submitHandler: function () {
                AjaxPostDataWithImage("<?=base_url('store/theme/one/featuresaction')?>","InsertForm", false, '<?=base_url('store/theme/one/features')?>');
            }
        });
    });
</script>