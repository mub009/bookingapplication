        ...
        <div class="portlet light form-fit bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">Add Why Choose Us List</span>
                </div>
            ...
            <div class="portlet-body form">
              <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label col-md-5" style=" text-align:left;" for="Heading">Details
                        <span class="required" aria-required="true"> * </span></label>
                    <div class="col-md-7 ">
    ...
    $(document).ready(function () {
        $('#InsertForm').validate({
            submitHandler: function () {
                AjaxPostDataWithImage("<?=base_url('store/theme/one/whychooseuslistaction')?>","InsertForm", false, '<?=base_url('store/theme/one/whychooseuslist')?>');
            }
        });
    });
</script>