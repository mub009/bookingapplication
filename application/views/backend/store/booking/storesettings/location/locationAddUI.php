		...
		<div class="portlet light form-fit bordered">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-green bold uppercase">Add Location</span>
				</div>
				<div class="actions">
			...
			<div class="portlet-body form">
				<div class="form-body">
					<div class="form-group">
						...
						<div class="col-md-4">
							<input type="text" require class="form-control" name="locationName_en"
								placeholder="In English" autocomplete="off" required >
						</div>
						<div class="col-md-4">
							<input type="text" require class="form-control" name="locationName_ar"
...
<script>
	$('#InsertForm').validate({
		submitHandler: function () {
			modalBasicAjaxPostData("<?=base_url('store/booking/storesettings/location/locationaddaction')?>", "InsertForm")
		}
	}); 
</script>