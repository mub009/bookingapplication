        ...
        <div class="portlet light form-fit bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">Add Service</span>
                </div>
            </div>
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-4">
                      ...
                      ?>
                      <option value="<?=$value['storeServiceCategoriesId']?>"><?=$value['categoryName_en']?></option>
                      <?php
                      }
                      ?>
                      </select>
                ...
                <div class="form-group">
                    <label class="control-label col-md-4" style=" text-align:left;" for="serviceName">Service Name
                        <span class="required" aria-required="true"> * </span></label>
                    <div class="col-md-4">
                        <input type="text" require="" class="form-control " name="serviceName_english"
                            placeholder="Enter English" autocomplete="off" required="" aria-invalid="false">
                    </div>
                    <div class="col-md-4">
                        <input type="text" require="" class="form-control " name="serviceName_arabic"
                ...
                <div class="form-group">
                    <label class="control-label col-md-4" style=" text-align:left;" for="Category">Service Description
                        <span class="required" aria-required="true"> * </span></label>
                    <div class="col-md-4">
                        <input type="text" require="" class="form-control " name="serviceDescription_en"
                            placeholder="Enter English" autocomplete="off" required="" aria-invalid="false">
                    </div>
                    <div class="col-md-4">
                        <input type="text" require="" class="form-control " name="serviceDescription_ar"
                            placeholder="Enter Arabic" autocomplete="off" required="" aria-invalid="false">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-4" style=" text-align:left;" for="cost">cost
                        <span class="required" aria-required="true"> * </span></label>
                    <div class="col-md-4">
                        <input type="text" require="" class="form-control " name="cost"
                ...
                <div class="form-group">
                    <label class="control-label col-md-4" style=" text-align:left;" for="duration">duration
                        <span class="required" aria-required="true"> * </span></label>
                    <div class="col-md-4">
                        <input type="text" require="" class="form-control " name="duration"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                      ...
                      ?>
                      <option value="<?=$value['storeEmployeeId']?>"><?=$value['userName']?></option>
                      <?php
                      }
                      ?>
                      </select>
                ...
                <div class="form-group">
                    <label class="control-label col-md-4" style=" text-align:left;" for="assignServicer">Is Need Multi Location?
                        <span class="required" aria-required="true"> * </span></label>
                    <div class="col-md-4">
    ...
    $(document).ready(function () {
        $('#InsertForm').validate({
            submitHandler: function () {
                AjaxPostDataWithImage("<?=base_url('store/booking/service/addaction')?>","InsertForm", false, '<?=base_url('store/booking/service/')?>');
            }
        });
