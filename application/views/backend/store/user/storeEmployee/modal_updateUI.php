		...
		<div class="portlet light form-fit bordered">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-green bold uppercase">Update Service Provider</span>
				</div>
				<div class="actions">
...
<script>
	$('#UpdateForm').validate({
		submitHandler: function () {
			modalBasicAjaxPostData("<?=base_url().'store/user/serviceprovider/editaction'?>", "UpdateForm")
		}
	});
</script>