		...
		<div class="portlet light form-fit bordered">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-green bold uppercase">Add Service Provider</span>
				</div>
				<div class="actions">
					...
					<div class="form-group">
						...
						<div class="col-md-7 ">
							<input type="text" require class="form-control" name="employeeUserName"
								placeholder="Enter Service Provider Name" autocomplete="off" required >
						</div>
					</div>
					<div class="form-group">
...
<script>
	$('#InsertForm').validate({
		rules: {
			employeeUserName: {
				required: true,
				remote: "<?=base_url().'store/user/employee/employee_username_validation'?>"
			}
		},
		messages: {
			employeeUserName: {
		...
		submitHandler: function () {
			modalBasicAjaxPostData("<?=base_url().'store/user/serviceprovider/post_employee'?>", "InsertForm")
		}
	}); 
</script>