...
$(document).ready(function () {
    $('#profileForm').validate({
		submitHandler: function () {
			AjaxPostDataWithImage("<?=base_url().'store/profile/profilephoto'?>", "profileForm",false,"<?=base_url().'admin/profile'?>");
		}
	});
    $('#personalInfoForm').validate({
		submitHandler: function () {
			modalBasicAjaxPostData("<?=base_url().'store/profile/updatepersonalInfo'?>", "personalInfoForm",false);
		}
	});

    $('#privacySettingsForm').validate({
		submitHandler: function () {
			modalBasicAjaxPostData("<?=base_url().'store/profile/privacyupdate'?>", "privacySettingsForm",false);
		}
	});
    $('#passwordForm').validate({
        rules: {
			oldPassword: {
				required: true,
				remote: "<?=base_url().'store/profile/oldpasswordchecking'?>",
			}
		},
		messages: {
			oldPassword: {
		...
		submitHandler: function () {
			modalBasicAjaxPostData("<?=base_url().'store/profile/passwordchange'?>", "passwordForm",false,"<?=base_url().'store/dashboard'?>");
		}
	});
});
