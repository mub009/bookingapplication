        ...
        <div class="portlet-body">
            ...
            <div class="col-md-3">
                    <div class="mt-widget-1">
                        <div class="mt-img">
                            <a class="linkVa" href="<?=base_url('store/service/addui')?>"><img src="<?=base_url().'assets\admin\assets\pages\img\plus.png'?>"></a> </div>
                    </div>
                </div>
                            ...
                            <h3 class="mt-username"><?=substr($row['serviceName_en'],0,28)?></h3>
                                <div class="mt-stats">
                                    <div class="btn-group btn-group btn-group-justified">
                                        <a href="<?=base_url('store/service/editform/'.dataEncode($row['storeServicesId']))?>"
                                            class="btn font-yellow linkVa">
                                            <i class="fa fa-pencil"></i> </a>
                                        <a href="<?=base_url('store/service/deleteui/'.dataEncode($row['storeServicesId']))?>"
                                            class="btn font-blue" data-target="#basic" data-toggle="modal">
                                            <i class="fa fa-trash-o"></i> </a>
                                        <a href="<?=base_url('store/service/hideorshowui/'.dataEncode($row['storeServicesId']))?>"
