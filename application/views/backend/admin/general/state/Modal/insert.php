...
?>
					...
					<div class="form-group">
						<label class="control-label col-md-5" style=" text-align:left;" for="StateName">State Name
							<span class="required" aria-required="true"> * </span></label>
						<div class="col-md-7 ">
							<input type="text" require class="form-control" id="StateName" name="StateName"
					...
					<div class="form-group">
						<label class="control-label col-md-5" style=" text-align:left;" for="StateCode">State Code
							<span class="required" aria-required="true"> * </span></label>
						<div class="col-md-7 ">
							<input type="text" require class="form-control" id="StateCode" name="StateCode"
	...
	$(document).ready(function () {
		$('#InsertForm').validate({
			submitHandler: function () {
				modalBasicAjaxPostData("<?=base_url().'admin/general/state/addaction'?>", "InsertForm")
			}
		});
	});
</script>