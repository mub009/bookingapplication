            ...
            <form action="" id="UpdateForm" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group" id="validation_Admin_number_update">
						<label class="control-label col-md-5" style=" text-align:left;">Time Zone *</label>
						<div class="col-md-7">

							<input type="text" class="form-control" id="edit_Time_Zone" name="TimeZone" placeholder="Enter Admin Mobile Number"
							 autocomplete="off">
						</div>
					</div>
    ...
    function editFunc(id) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#edit_Time_Zone").val(response[0].TimeZone);
