<div class="modal-body">
    <div class="portlet light form-fit bordered">
        ...
        <div class="portlet-body form">
            ...
            <div class="form-group" id="validation_TimeZone_insert">
                        <label class="control-label col-md-5" style=" text-align:left;">Time Zone <span class="required" aria-required="true"> * </span></label>
                        <div class="col-md-7">

                            <input type="text" class="form-control" id="TimeZone" name="TimeZone" placeholder="Enter Time Zone"
                                autocomplete="off">
        ...
        $.ajax({
            ...
            error: function (jqXhr) {
                ...
                if (typeof json.mobile_number != 'undefined') {
                  ...
                  if (typeof json.TimeZone != 'undefined') {


$("#validation_TimeZone_insert").addClass("has-error");

$('#error_TimeZone_insert').remove();

$('#validation_TimeZone_insert .col-md-7').append(
    "<span class='help-block' id='error_TimeZone_insert'>" + json.TimeZone +
    "</span>");

} else {
$("#validation_TimeZone_insert").removeClass("has-error");

$('#error_TimeZone_insert').remove();

$("#validation_TimeZone_insert").addClass("has-success");
